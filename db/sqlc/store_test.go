...
func TestTransferTx(t *testing.T)  {
	...
	// We created 5 go routines to execute 5 concurrent transactions
	n := 5
	amount := int64(10)
	...
	Iterate through the list of results to check the created transfer and entry object
	*/
	for i :=0; i < n; i++ {
	...
	for i := 0; i < n ; i ++ {
		...
		// check if transfer is created in the database
